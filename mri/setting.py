...
def parse_opts():
    ...
    parser.add_argument(
        '--train_img_list',
        default='spilt/train1.txt',
        type=str,
        help='Path for image list file')
    parser.add_argument(
        '--val_img_list',
        default='spiltvalid_1.txt',
        type=str,
        help='Path for image list file')
    ...
    parser.add_argument(
        ...
        type=int,              
        help='Gpu id lists')
    parser.set_defaults(gpu_id=[4,5,6,7])
    ...
    args.save_folder = "./weights/denset/fold4_g/"#weights/resnet50_mask_l1+ce_dp_adam/new_fold4
